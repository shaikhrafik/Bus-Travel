...
## BUS TRAVEL :- BUS RESERVATION MANAGEMENT PORTAL
...
* Before running the API server, you should update the database config inside the [application.properties](https://github.com/shaikhrafik/Bus-Travel/blob/master/Safar-main/Backend/bus_reservation/src/main/resources/application.properties) file. 
